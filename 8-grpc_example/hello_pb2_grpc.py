...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamHello = channel.unary_stream(
                '/hello.Greeter/StreamHello',
                request_serializer=hello__pb2.HelloRequest.SerializeToString,
                response_deserializer=hello__pb2.HelloReply.FromString,
                _registered_method=True)
        self.SendNames = channel.stream_unary(
                '/hello.Greeter/SendNames',
                request_serializer=hello__pb2.HelloRequest.SerializeToString,
                response_deserializer=hello__pb2.HelloReply.FromString,
                _registered_method=True)
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SendNames': grpc.stream_unary_rpc_method_handler(
                    servicer.SendNames,
                    request_deserializer=hello__pb2.HelloRequest.FromString,
                    response_serializer=hello__pb2.HelloReply.SerializeToString,
            ),
...
class Greeter(object):
    ...
    @staticmethod
    def SendNames(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
